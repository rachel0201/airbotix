...
2. **Kids AI Platform**（规划中）：`platform-backend` + `kids-web` + `kids-opencode` + `teacher-console`
...
- **云平台**: AWS Sydney (ap-southeast-2)，单点 EC2 起步
- **CDN**: Cloudflare Pages (前端)
...
├── kids-web/              # (规划中) Line A 低龄创作 web
├── kids-opencode/         # (规划中) Line B 12+ fork of opencode
├── teacher-console/       # (规划中) 老师/管理后台 (替代已删除的 super-admin)
├── docs/                  # 项目文档
│   ├── frontend/          # 前端文档
│   ├── backend/           # 后端文档
│   ├── product/           # 产品文档
