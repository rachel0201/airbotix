...
**年龄分层**：
- Ages 8-11：**AI Creative Lab**（图像 / 故事 / 配音，无 coding）
...
**Pricing**（建议初始定价）：[TBD: 建议 A$50-70/课 × 8 课 = A$400-560/term/学生]
...
**Pricing**：[TBD: 建议 A$120-160/小时；10 课包 A$1100-1400]
...
| Small group class（per term, 8 课） | **A$480** | A$60/课 |
| Small group class（per term, 10 课） | **A$600** | A$60/课，AI Coding Studio |
| 1-on-1 single | **A$140/hour** | |
| 1-on-1 10-pack | **A$1,300** | A$130/hour，5-10% off |
| 1-on-1 20-pack | **A$2,400** | A$120/hour，~15% off |
...
| Q2 | 1-on-1 起步定价取 A$140/h 可接受吗？还是想试试 A$160-180/h（AU 高端 tutoring 顶端）？ | 影响 GTM 信号（贵 = premium / 便宜 = 拼竞争） |
