...
**Pricing**（2026-05-15 二次调整 — 各报各 -A$10，从 A$70 起步）：
- Single session — **A$70/hour**
- 10-pack — **A$650**（A$65/hour，省 A$50）
- 20-pack — **A$1,200**（A$60/hour，省 A$200）

[备注] 起步定价 A$70/h 是中段入门价位（对标 AU 一般在线 tutoring A$60-100/h），主打"用 AI 工具的私教，进入门槛低"。Pilot 期跑 1-2 个月后看复购 / 家长反馈，再决定是否升至 A$100-140/h premium 路线。
...
| HACKATHONS / Coming 2026 → | **1-ON-1 TUTORING** / `Private AI coding sessions with senior instructors. From A$70/hr.` / `Book a session →` |
...
| 1-on-1 single | **A$70/hour** | 二次调整后（2026-05-15 同日） |
| 1-on-1 10-pack | **A$650** | A$65/hour，省 A$50 |
| 1-on-1 20-pack | **A$1,200** | A$60/hour，省 A$200 |
...
| ~~Q2~~ | ~~1-on-1 起步定价~~ | ✅ **2026-05-15 二次调整**：A$70/h 起步，10-pack A$650，20-pack A$1,200。原 A$80 起步偏贵，下调 A$10 后落在 AU 市场中段（Cluey/Maths Pathway 区间）。Pilot 后视复购再调 |
